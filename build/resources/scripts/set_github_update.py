...
Run on /home/pi, the folder nex-Printer-Release-master must be in the same directory.
...
- Clone https://github.com/Global3DSystems/nex-Printer-Release 
...
- Copy all contents of the nex-Printer-Release-master to Release/nex-Printer-Release-master.
...
if __name__ == "__main__":
    ...
    print("Creating nex_update_temp folder to store .git, .gitignore and README.md...")
    time.sleep(delay_sec)
    os.mkdir("nex_update_temp")
    shutil.copytree(".git", "nex_update_temp/.git", dirs_exist_ok = True)
    shutil.move(".gitignore", "nex_update_temp")
    shutil.move("README.md", "nex_update_temp")

    print("Deleting all old files except the nex_update_temp folder...")
    time.sleep(delay_sec)
    os.system(r"find . -mindepth 1 ! -regex '^./nex_update_temp\(/.*\)?' -delete")
    ...
    print("Copying latest README.md, .git and .gitignore from nex_update_temp...")
    time.sleep(delay_sec)
    shutil.copytree("nex_update_temp/.git", os.path.join(os.getcwd(), ".git"))
    shutil.copy("nex_update_temp/.gitignore", os.getcwd())
    shutil.copy("nex_update_temp/README.md", os.getcwd())

    print("Deleting nex_update_temp...")
    time.sleep(delay_sec)
    shutil.rmtree("nex_update_temp")
    ...
    [The one located at Release/nex-Printer-Release-master]
    > git add -A
